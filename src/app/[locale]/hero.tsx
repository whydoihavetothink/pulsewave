...
function Hero() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-[url('/media/banners/argy.png')] bg-cover bg-no-repeat bg-top">
      <video
        autoPlay
        loop
        muted
      ...
      <div className="grid min-h-screen px-8">
        <div className="container relative z-10 my-auto mx-auto grid place-items-center text-center" style={{ paddingTop: "24rem" }}>
